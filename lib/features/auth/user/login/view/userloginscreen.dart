...
import 'package:mydoctor/features/auth/user/login/controller/loginusercontroller.dart';
...
class Userloginscreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<Loginusercontroller>(builder: (controller) {
      return Scaffold(
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          Get.toNamed(AppRouter.kCheckemailScreen);
                        },
                        child: Text(
                          "9".tr,
