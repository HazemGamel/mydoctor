...
import 'package:mydoctor/features/auth/forgetpassword/controller/otpforforgetpasswordcontroller.dart';
...
class Otpscreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Get.lazyPut(() => Otpforforgetpasswordcontroller());
    return GetBuilder<Otpforforgetpasswordcontroller>(builder: (controller) {
      return Scaffold(
                    ...
                    children: [
                      ...
                      OtpTextField(
                        ...
                        onSubmit: (String verificationCode) {
                          controller.otpForgetpassword(verificationCode);
                        },
                      ),
                    ],
                  ),
