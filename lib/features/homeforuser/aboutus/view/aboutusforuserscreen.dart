...
import 'package:mydoctor/features/homeforuser/aboutus/controller/aboutusforusercontroller.dart';

class Aboutusforuserscreen extends StatelessWidget {
  const Aboutusforuserscreen({super.key});

  @override
  Widget build(BuildContext context) {
    double screenHeight = MediaQuery.of(context).size.height;
    Get.lazyPut(() => Aboutusforusercontroller());
    return Scaffold(
        ...
        body: GetBuilder<Aboutusforusercontroller>(builder: (controller) {
